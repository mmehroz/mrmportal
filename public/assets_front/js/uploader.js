...
function createUploader(ids,functions,file_types = ['jpg', 'jpeg', 'png', 'gif', 'bmp' ])
{
	var image_filter=file_types;
	var image_string= file_types.join(', '); // " jpg, jpeg, png, gif, bmp , mp4";
