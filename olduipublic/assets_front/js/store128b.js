...
jQuery(document).ready(function() {	
    ...
    $(window).on('load', function () {
        var merchant_id = $("#merchant_id").val();
         var params="action=viewMenuDynamic&currentController=store&width=80&tbl=viewMenuDynamic&merchant_id="+merchant_id;
            load_dynamic_menu(params);
        // if (screen.width < 400 ) {
        //     var params="action=viewMenuDynamic&currentController=store&width=10&tbl=viewMenuDynamic&merchant_id="+merchant_id;
        //     load_dynamic_menu(params);
        // }else if (screen.width > 400 && screen.width < 600 ) {
        //     var params="action=viewMenuDynamic&currentController=store&width=20&tbl=viewMenuDynamic&merchant_id="+merchant_id;
        //     load_dynamic_menu(params);
        // }else if (screen.width > 600 && screen.width < 800 ) {
        //     var params="action=viewMenuDynamic&currentController=store&width=30&tbl=viewMenuDynamic&merchant_id="+merchant_id;
        //     load_dynamic_menu(params);
        // }else if (screen.width > 800 && screen.width < 1000 ) {
        //     var params="action=viewMenuDynamic&currentController=store&width=35&tbl=viewMenuDynamic&merchant_id="+merchant_id;
        //     load_dynamic_menu(params);
        // }else if (screen.width > 1000 && screen.width < 1200 ) {
        //     var params="action=viewMenuDynamic&currentController=store&width=60&tbl=viewMenuDynamic&merchant_id="+merchant_id;
        //     load_dynamic_menu(params);
        // }else if (screen.width > 1200 && screen.width < 1600 ) {
        //     var params="action=viewMenuDynamic&currentController=store&width=70&tbl=viewMenuDynamic&merchant_id="+merchant_id;
        //     load_dynamic_menu(params);
   	   	   	   ...
   	   	   	   if ( $(this).val()==2 ) {
	   	   	   	   ...
	   	   	   	   if ( addon_type=="select"){
	   	   	   	   	   ...
	   	   	   	   	   if ( empty(required_addon_selected) || required_addon_selected=="0"){
		   	   	   	   	   ...
		   	   	   	   	   $(".require_addon_"+required_addon_id+"+.section-label").after(
...
{	
    ...
    // 	if( $('.slide-toggle').is(':visible') ) {			
	   ...
	   // }
    	...
    	console.log("FbPix" , data.details.fb_pix);
    	if(data.details.fb_pix.value != undefined){
			if(typeof(fbq) !== 'undefined')
    	    	fbq('track', 'InitiateCheckout', data.details.fb_pix );
		}
		
		if (data.details.gtag_products || data.details.gtag_products_ua) {
			if(typeof(gtag) == 'function') {
				var _items = data.details.gtag_products;
				if(window.isUA) {
					_items = data.details.gtag_products_ua;
				}
