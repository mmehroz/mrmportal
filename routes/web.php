...
Route::get('edittarget/{id}', 'DailyTargetController@edittarget');


Route::get('dashboard/editjss/{id}', 'ProfileController@editjss');
Route::any('dashboard/submiteditjss', 'ProfileController@submiteditjss');