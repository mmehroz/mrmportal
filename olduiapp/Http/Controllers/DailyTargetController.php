...
//                dump(str_replace('$', '', $value->amount));
        ...
        return view($section->folder.'.indexSales', compact('targets', 'section','date_from','date_to','name','biddersUsers', 'dailytarget', 'timePeriod', 'profile', 'profile_link', 'sales_targets', 'totalSumAmount', 'totalSalePersonId'));
    }
...
//        dd($targets->toArray());
    ...
    public function edit($id)
    {
        ...
        $profile = Profile::where('status', 1)->pluck('name', 'id')->toArray();
//        dd($profile, $sale_person_id);
        return view($section->folder.'.form', compact('target', 'section', 'profile','sale_person_id'));
    }
