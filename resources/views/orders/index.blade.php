...
.nk-block-head-content.new-invoice {
    flex-flow: column;
}
                ...
                <div class="nk-content-body">
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            ...
                            <div class="nk-block-head-content new-invoice">
...
{{--                                            {!! Form::button('Submit', ['type' => 'submit', 'class' => 'btn btn-primary waves-effect waves-light']) !!}--}}
                                ...
                                {!! Form::close() !!}
                                <a  href ="{{ route("order.create") }}" class="btn btn-primary newbid-btn " style="color: #fff;">Add New Invoice</a>
