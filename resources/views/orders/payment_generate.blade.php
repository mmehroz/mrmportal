                            ...
                            <div class="nk-block-head-content">
                                ...
                                <nav>
                                    <ul class="breadcrumb">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{ route("category.index") }}">{{ $section->heading }}</a></li>
                        ...
                        <div class="nk-block nk-block-lg">
                            <div class="card card-bordered">
                                <div class="card-inner">
                                    {!! Form::model($category, ['route' => $section->route, 'class' => 'form-validate', 'files' => true, 'enctype' => 'multipart/form-data']) !!}
                                    @method($section->method)
                                        <div class="row g-gs">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="form-control-wrap">
                                                        {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Enter Category Name', 'required' => 'required', 'name' => 'name']) !!}
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-12">
                                                    <img class="email-logo" src="{{ asset($category->picture) }}" alt="logo" style="width: 100%;">
                                                </div>

                                            @endif
{{--                                            <div class="col-md-6">--}}
{{--                                                <div class="form-group">--}}
{{--                                                    <label class="form-label" for="fv-topics">Have Variant?</label>--}}
{{--                                                    <div class="form-control-wrap ">--}}
{{--                                                        {!! Form::select('variant', array(1 => 'Yes', 0 => 'No'), null, ['class' => 'form-control form-select', 'placeholder' => 'Select a option', 'required' => 'required']); !!}--}}
{{--                                                        {!! Form::switch('variant', 1, $category->variant, ['data-on-label' => 'Yes', 'data-off-label' => 'No' ,'id' => 'variant']) !!}--}}
{{--                                                    </div>--}}
{{--                                                </div>--}}
{{--                                            </div>--}}
                                            <div class="col-md-12">
