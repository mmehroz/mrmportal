...
.daily-progress-table {justify-content: flex-end;align-items: end;margin-right: 25px;}
...
.progg .card-inner {
    padding: 10px 45px 11px 30px !important;
}
...
.components-preview td {
    text-align: center;
}

.components-preview td.fixed-side {
    text-align: left;
}
...
.row.align-items-end.daily-progress-table {
...
{{--                                <a href="{{ route("daily_target.create") }}" class="btn btn-primary">Add New {{ $section->heading }}</a>--}}
                    ...
                    <div class="components-preview">
                        ...
                        <div class="nk-block  nk-block-lg">
                            <div class="card card-preview" style="border-radius: 0px 0px 20px 20px !important;">
                                <div class="card-inner">
