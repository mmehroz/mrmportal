        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                ...
                <!-- Form with validation -->
                 ...
                 {!! Form::model($team, ['route' => $section->route, 'class' => 'form-validate is-alter', 'files' => true, 'enctype' => 'multipart/form-data', 'autocomplete' => 'off']) !!}
                                        ...
                                        <div class=" g-gs">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    {!! Form::button('Add New Team', ['type' => 'submit', 'class' => 'btn btn-primary pop-btn']) !!}
